...
# DEBUGGING: Print the keys to the Streamlit UI to see what the .pkl file ACTUALLY contains
st.write("DEBUG KEYS:", list(pipeline.named_steps.keys()))
...
if st.button("Predict"):
    ...
    preprocessor = pipeline.named_steps['trf1']
    selector = pipeline.named_steps['trf2']
    model = pipeline.named_steps['adv_model']
